...
<div class="w3-container" style="margin-top:0px;">
	<c:set var="noticeBoardMemberCount" value="${ sessionScope._MEMBER_.noticeBoardMemberCount }" />
	...
	<div class="w3-row" >
         ...
         <!-- 게시판 헤더 -->
            ...
            <div class="w3-margin-4" style="float:left; padding-left:10px;">
					...
					<div style="float:left; padding-top:20px;">
						<h5>참여인원 ${noticeBoardMemberCount }명</h5> 
					</div>
		...
		<c:forEach items="${promotionArticles}" var="article">
			<div class="w3-row-padding w3-margin-top">
				<div class="w3-col m12">
					
						<div class="w3-card w3-white w3-round-large">
							<div class="w3-container">
							<a href="<c:url value="/hitsCount?boardId=3&articleId=${article.articleId}"/>">
								<div class="w3-col m10 w3-padding-top">
                           ...
                           <c:if test="${article.scrab}">
                              <span class="scrab glyphicon glyphicon glyphicon-tag scrab${topArticle.articleId}" id="scrab${article.articleId}" style="color:#a9d039;"></span>  스크랩하기&nbsp; &nbsp;
                           </c:if>
                           
                           <c:if test="${!article.scrab}">
                              <span class="scrab glyphicon glyphicon glyphicon-tag scrab${topArticle.articleId}" id="scrab${article.articleId}" style="color:#7d7d7d;"></span>  스크랩하기&nbsp; &nbsp;
                           </c:if>
