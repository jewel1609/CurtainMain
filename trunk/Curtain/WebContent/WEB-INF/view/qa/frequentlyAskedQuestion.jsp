					...
					<div class="w3-row-padding" style="border-bottom:1px solid #BABABA;">
							...
							<div class="w3-container w3-card w3-round-large w3-white" style="margin-bottom: 10px; padding: 10px;" >
								...
								<div id="firstFAQ" style="margin-top: 20px; padding-left: 30px;">
									학생 회원인 경우 포인트는 홍보게시판을 제외한 게시판에서 글을 쓸 때 <b>10포인트</b>씩 적립됩니다.
									<br /><br />
									하지만 <b>하루에 5개</b>의 게시글만 포인트가 상승합니다.
									<br /><br />
									기업 회원의 경우에는 포인트를 구매 할 수 있습니다.(구매는 마이페이지의 설명을 참고해주세요.)    
									<br /><br />
									적립된 포인트는 <b>홍보게시판</b>에 <b>100 포인트</b>를 주고 글을 올릴 수 있습니다.
									<br /><br />
							...
							<div class="w3-container w3-card w3-round-large w3-white" style="margin-bottom: 10px; padding: 10px 10px 10px 10px;">
								...
								<div id="secondFAQ" style="margin-top: 20px; padding-left: 30px;">
									...
									<td>
										<img src="/resource/img/window.png"> 
									</td>
										<td>
									...
									<tr style="width:150px;">
									  <th>
									    <img src="/resource/img/oneLayerCurtain.png">
									  </th>
									  <td>
									    학생 회원이 다음 조건을 만족하게 되면 등급이 한겹커튼으로 상승하게 됩니다.<br/>(총 게시글 5개, 댓글 10개, 투표를 7회 이상)
									    <br /><br />한겹커튼 등급의 회원은 비밀게시판 중 한겹게시판을 이용 할 수 있습니다.
									  </td>
									 
									</tr>
									<tr>
										<td>
											<img src="/resource/img/twoLayerCurtain.png">
										</td>
										<td>
											학생 회원이 다음 조건을 만족하게 되면 등급이 두겹커튼으로 상승하게 됩니다.<br/>(총 게시글 15개, 댓글 30개, 투표를 21회 이상)
											<br/><br/>
									...
									<tr>
										<td>
											<img src="/resource/img/company.png">
										</td>
										<td>
											기업 회원의 경우 처음 가입하면 홍보게시판만 볼 수 있는 홍보담당자 등급이 됩니다.
										</td>
									</tr>
									<tr>
										<td>
											<img src="/resource/img/company2.png">
										</td>
										<td>
											기업 회원이 포인트를 결제하면 홍보게시판에 글을 쓸 수 있는 홍보담당자(글) 등급이 됩니다.
										</td>
									</tr>	
									</tbody>																	
									</table>
